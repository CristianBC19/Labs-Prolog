% ============================================
% Lab 02 - Expert System in Prolog
% Topic: PC Troubleshooting System
% ============================================
% Author: [Tu Nombre]
% Date: [Fecha]
% Course: Mathematical and Computational Logic
% ============================================

% ---------------------------
% Step 1: Knowledge Base
% ---------------------------
% Definición de problemas y sus propiedades
...
% Possible causes (associated with specific symptoms)
...
% ---------------------------
% Step 5: Recursive Rule (Ancestor-style)
% ---------------------------
...
is_subcategory(X, Y) :- category(X, Y).              % caso base
is_subcategory(X, Y) :- category(X, Z), is_subcategory(Z, Y).  % caso recursivo
